...
<body>
	...
	<div class="articlelist-container col-md-offset-1 col-md-10 col-xs-offset-1 col-xs-10">
		<div class="articlelist panel panel-info col-md-12">
			<div class="panel-heading">文章查询结果</div>
	...
	<div class="booklist-container col-md-offset-1 col-md-10 col-xs-offset-1 col-xs-10">
		<div class="booklist panel panel-danger col-md-12">
			<div class="panel-heading">图书查询结果</div>
			<div class="table-responsive">
